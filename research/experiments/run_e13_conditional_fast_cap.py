...
"""E13 conditional Fast-cap runner."""
...
def print_summary(report) -> None:
    ...
    pin = gate["pin"]
    print(
        f"E13 pin matched={pin['matched']} fidelity={pin['replica_fidelity']} "
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    if args.output.exists() or args.audit_output.exists():
        raise RuntimeError("e13 output already exists; refuse overwrite")
