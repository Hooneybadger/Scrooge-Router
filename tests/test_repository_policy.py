...
class RepositoryPolicyTest(unittest.TestCase):
    ...
    def test_sensitive_and_materialized_paths_are_ignored(self) -> None:
        ...
        expected_dockerignore = [
            ...
            "!src/ossp_router/budget_brake_router.py",
            "!src/ossp_router/cli.py",
            "!src/ossp_router/cost_calibrated_router.py",
            "!src/ossp_router/distributional_router.py",
            "!src/ossp_router/family_guard_router.py",
            "!src/ossp_router/feasibility_ladder.py",
            "!src/ossp_router/heuristic.py",
            "!src/ossp_router/image_evidence.py",
            "!src/ossp_router/operator_helper.py",
            "!src/ossp_router/orchestrator.py",
            ...
            "!src/ossp_router/resources/budget-brake-router.v1.json",
            "!src/ossp_router/resources/cost-calibrated-router.v1.json",
            "!src/ossp_router/resources/distributional-router.v1.json",
            "!src/ossp_router/resources/family-guard-router.v1.json",
            "!src/ossp_router/resources/feasibility-ladder.v1.json",
            "!src/ossp_router/resources/routing-policy.v1.json",
            "!baselines/",
            "baselines/**",
            "!baselines/feature_budget.py",
